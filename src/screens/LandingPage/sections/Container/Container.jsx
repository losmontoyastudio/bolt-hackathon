...
export const Container = () => {
  return (
    <div id="sponsors" className="container section-animate">
      <div className="sponsors-container">
        <div className="sponsors-section">
          <div className="title-4">
            <div className="title-5">sponsors</div>
          </div>

          <div className="sponsors-description">
            <p className="description-5">
              <span className="text-wrapper-14">
                global partners bringing resources and expertise to
                fuel innovation. join the ecosystem of leading
                companies supporting the next generation of software
        ...
        <div className="sponsors-list">
          <div className="sponsor-tier">
            <div className="div-7">
              <div className="div-8">
                <div className="header-texts">
                  <div className="english-header">partner_tier_01</div>

                  <div className="japanese-header">協賛_01</div>
                </div>

                <div className="div-wrapper-2">
                  <p className="description-6">
                    premium partners / full access / main stage demos / api
                    priority
                  </p>
                </div>
              </div>
            ...
            <div className="div-7">
              <div className="div-8">
                <div className="header-texts">
                  <div className="english-header">partner_tier_02</div>

                  <div className="japanese-header">協賛_02</div>
                </div>

                <div className="div-wrapper-2">
                  <p className="description-6">
                    supporting partners / limited access / ecosystem visibility
                    / sessions
                  </p>
                </div>
              </div>
              ...
              <div className="div-wrapper-2">
                <div className="submission-deadline-3">
